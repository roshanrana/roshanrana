...
| **[REGLENS](https://github.com/roshanrana/RegLens)** · Python, FastAPI, SQLite, Qdrant | Compliance teams need answers they can cite, and a RAG system that paraphrases a rule is worse than no system. | Hybrid retrieval with exact-citation routing, quote verification against retrieved evidence, abstention on weak evidence, hash-chained query audits with reviewer-ready exports, durable chat sessions, and adversarial prompt-injection evals, all runnable offline. 275 tests. |
