...
FinTech integrations and delivery specialist with 18 years of experience, now focused on Forward Deployed Engineering work where customer workflows, production systems, AI, and audit expectations meet.
...
These projects are intentionally FinTech-leaning and FDE-shaped:

- They start from operational problems a financial institution would recognize: reconciliation, regulatory research, and controlled AI infrastructure.
...
- They expose integration surfaces: CLIs, APIs, event contracts, Docker profiles, audit exports, and runbooks.
